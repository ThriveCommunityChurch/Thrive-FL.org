...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for Thrive Community Church website and applications - how we collect, use, and protect your information.",
  openGraph: {
    title: "Privacy Policy | Thrive Community Church",
    ...
    <div className="page-wrapper">
      ...
      <section className="page-hero page-hero-privacy">
        ...
        <div className="page-hero-content">
          ...
          <p className="page-hero-subtitle">Your privacy matters to us</p>
        </div>
      </section>
      ...
      <section className="section privacy-content-section">
        <div className="container container-narrow">
          ...
          <div className="privacy-content">
            <h2>Introduction</h2>
            <p>
              Thrive Community Church (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) respects
              your privacy and is committed to protecting your personal information. This Privacy
              Policy explains how we collect, use, and safeguard information when you visit our
              website at thrive-fl.org or use our mobile applications and digital services.
            </p>
            ...
            <ul>
              <li>
                Our website at <strong>thrive-fl.org</strong>
              </li>
              <li>
                The <strong>Thrive Church Official App</strong> (iOS and cross-platform versions)
              </li>
              <li>Our sermon streaming and podcast services</li>
              <li>Any other digital services we provide</li>
            </ul>
            <p>
              By using any of these services, you agree to the collection and use of information in
            ...
            <p>
              This information is used to improve our website and better serve our community. Google
              Analytics uses cookies to collect this data. You can opt out of Google Analytics by
              installing the{" "}
              <a
            ...
            <h3>App Analytics</h3>
            <p>
              Our mobile applications may collect diagnostic and usage data to help us improve app
              performance and user experience. This includes crash reports, performance metrics, and
              feature usage statistics. This data is collected anonymously and is used solely to
            ...
            <p>
              ...
              operating our website and apps, conducting our ministry, or serving you, so long as
              those parties agree to keep this information confidential.
            </p>
            <p>
              Prayer requests may be shared with our prayer team unless you request otherwise. We
              treat all pastoral communications with the utmost confidentiality.
            </p>
            ...
            <ul>
              <li>
                <strong>Google Analytics</strong> - for website and app analytics
              </li>
              <li>
                <strong>Google Maps</strong> - to display our location and provide directions
              </li>
              <li>
                <strong>YouTube</strong> - for embedded video content and live streams
              </li>
              <li>
                <strong>Amazon Web Services (AWS)</strong> - for hosting and content delivery
              </li>
              <li>
            ...
            <p>
              These services may collect information according to their own privacy policies. We
            ...
            <p>
              ...
              experience and collect analytics data. Cookies are small files stored on your device
              that help us understand how you use our site.
            </p>
            ...
            <p>
              You can set your browser to refuse cookies, though this may limit some website
              functionality. Most browsers allow you to manage cookie preferences in their settings.
            </p>

            <h2>Data Security</h2>
            <p>
              We implement reasonable security measures to protect your personal information,
              including encryption for data transmission and secure hosting infrastructure. However,
            ...
            <p>
              ...
              Analytics data is typically retained in aggregated, anonymized form.
            </p>

            <h2>Children&apos;s Privacy</h2>
            <p>
              Our website and apps are not intended for children under 13. We do not knowingly
            ...
            <div className="privacy-contact">
              <p>
                <strong>Thrive Community Church</strong>
              </p>
              <p>
              ...
              <p>
                Phone: <a href="tel:+12396873430">(239) 687-3430</a>
              </p>
              <p>
                Email: <a href="mailto:info@thrive-fl.org">info@thrive-fl.org</a>
              </p>
            </div>
          </div>
        </div>
