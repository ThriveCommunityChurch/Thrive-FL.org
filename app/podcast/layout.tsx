...
export const metadata: Metadata = {
  ...
  description:
    "Subscribe to the Thrive Community Church podcast. Listen to our weekly messages on Apple Podcasts, Spotify, Amazon Music, and more.",
  openGraph: {
    title: "Podcast | Thrive Community Church",
    description:
      "Take our messages with you wherever you go. Subscribe on Apple Podcasts, Spotify, Amazon Music, and more.",
...
const jsonLd = {
  ...
  description:
    "Listen to sermons and teachings from Thrive Community Church in Fort Myers, Florida. Pastor John Roth shares messages to help you grow in your faith and live out your purpose.",
  url: "https://thrive-fl.org/podcast",
