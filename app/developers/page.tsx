...
export const metadata: Metadata = {
  ...
  description:
    "Discover the volunteer-built tools that power Thrive Community Church — from our mobile app to sermon transcripts. Technology serving our mission.",
  openGraph: {
    title: "Built by Volunteers | Thrive Community Church",
    description:
      "Discover the volunteer-built tools that power our church. Technology serving our mission.",
    ...
    <div className="page-wrapper">
      ...
      <section className="page-hero page-hero-developers">
        ...
        <div className="page-hero-content">
          ...
          <p className="page-hero-subtitle">Volunteer-built tools that power our church</p>
        </div>
      </section>
      ...
      <section className="section intro-section developers-intro-section">
        <div className="container container-narrow">
          <div className="intro-content">
            ...
            <p>
              At Thrive, we believe that if someone can&apos;t make it to church on Sunday, they
              should still be able to hear the Word. If a busy parent wants to revisit a sermon
              during nap time, that should be easy. If someone across the country stumbles onto our
              podcast, they should be able to connect with our community. Since 2017,
              volunteer-built software has helped make that possible — not because we love
              technology for its own sake, but because we believe every tool we build is an
              opportunity to reach one more person with the Gospel. Using our gifts in service of
              the mission is our way of serving Jesus.
            </p>
            <p>
                ...
                <div className="developers-project-content">
                  ...
                  <div className="developers-project-tech">
                    {project.tech.map((t, i) => (
                      <span key={i} className="developers-tech-badge">
                        {t}
                      </span>
                    ))}
                  </div>
      ...
      <section className="section developers-cta-section">
        <div className="container container-narrow">
          <div className="cta-content">
            ...
            <p>
              Are you a developer? All of our projects are open source and available on GitHub.
              Whether you&apos;re curious about how something works, want to contribute, or are
              looking for ideas for your own church — feel free to explore.
            </p>
            <CTAButtons>
              <a
