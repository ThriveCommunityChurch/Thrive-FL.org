...
export const metadata: Metadata = {
  ...
  description:
    "Theocology is the podcast that discusses why theology matters during your college years - actually always. Hosted by Pastor John Roth with FGCU students discussing faith and life.",
  openGraph: {
    title: "Theocology Podcast | ThriveFGCU",
    description:
      "Why theology matters during your college years—actually always. A podcast from ThriveFGCU at Florida Gulf Coast University with Pastor John Roth.",
...
const jsonLd = {
  ...
  name: "Theocology",
  description:
    "Theocology is the podcast that discusses why theology matters during your college years - actually always. Pastor John Roth, a professor at Florida Gulf Coast University, hosts students who discuss matters of faith and life each week during the academic year.",
  url: "https://thrive-fl.org/ministries/college/podcast",
...
export default function TheocologyLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <script
