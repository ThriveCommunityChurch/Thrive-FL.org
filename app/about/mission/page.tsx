...
export const metadata: Metadata = {
  ...
  description:
    "Thrive exists to bless and disciple people so they thrive in their relationship with Jesus Christ and others. Reaching Southwest Florida with hope and faith.",
  openGraph: {
    title: "Our Mission | Thrive Community Church",
    ...
    <div className="page-wrapper">
      ...
      <section className="page-hero page-hero-mission">
        ...
        <div className="page-hero-content">
          ...
          <p className="page-hero-subtitle">A beacon of hope and faith for our community</p>
        </div>
      </section>
        ...
        <div className="container container-narrow">
          <div className="mission-statement-content">
            ...
            <h2 className="mission-statement-text">
              Thrive exists to <span className="highlight">bless and disciple people</span> so that
              they thrive in their relationship with Jesus Christ and others, creating Christian
              community.
            </h2>
          </div>
        </div>
          ...
          <div className="mission-vision-layout">
            <div className="mission-vision-content">
              ...
              <p className="mission-vision-lead">
                We envision a church that is a <strong>beacon of hope and faith</strong> for the
                FGCU campus, the Estero community, and beyond.
              </p>
              <p>
                Our vision is to help people find their <strong>purpose and calling</strong> through
                Christ—to discover who God made them to be and live out that calling in every area
                of their lives.
              </p>
              <p>
                Whether you&apos;re a college student navigating the challenges of young adulthood,
                a family seeking a place to grow together, or someone searching for meaning and
                community, Thrive is a place where you can belong, grow, and find your way.
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="mission-pillars-grid">
            <div className="mission-pillar-card">
              ...
              <p>
                Thrive was born on the FGCU campus, and we remain committed to reaching college
                students with the love of Christ. Through ThriveFGCU, we provide community,
                mentorship, and a place to explore faith during a pivotal season of life.
              </p>
            ...
            <div className="mission-pillar-card">
              ...
              <p>
                We want Estero, San Carlos, and Southwest Florida to be better because Thrive is
                here. Through local outreach, partnerships, and simply being good neighbors, we seek
                to make a tangible difference in the lives of those around us.
              </p>
            ...
            <div className="mission-pillar-card">
              ...
              <p>
                We don&apos;t just want people to attend—we want them to grow. Through worship,
                small groups, mentorship, and serving, we help people deepen their relationship with
                Jesus and discover their unique calling.
              </p>
        ...
        <div className="container">
          <div className="mission-purpose-layout">
            ...
            <div className="mission-purpose-content">
              ...
              <p>
                We believe that every person is created by God with a unique purpose. Our job
                isn&apos;t to tell you what that purpose is—it&apos;s to help you discover it for
                yourself through a relationship with Jesus.
              </p>
              <p>
                At Thrive, you&apos;ll find a community that encourages you to ask the big
                questions: <em>Why am I here? What am I made for? How can I make a difference?</em>
              </p>
              <p>
                Whether you&apos;re just starting to explore faith or you&apos;ve been following
                Jesus for years, there&apos;s always more to discover about who God made you to be.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section cta-section mission-cta">
        <div className="container container-narrow">
          <div className="cta-content">
            ...
            <p>
              We&apos;d love to have you join us. Come see what Thrive is all about and discover how
              you can be part of what God is doing in Estero.
            </p>
            <CTAButtons>
