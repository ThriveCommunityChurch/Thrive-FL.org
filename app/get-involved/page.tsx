...
export const metadata: Metadata = {
  ...
  description:
    "Serve at Thrive Community Church. Discover volunteer opportunities in worship, kids ministry, hospitality, tech, and more. Use your gifts to make a difference.",
  openGraph: {
    title: "Get Involved | Thrive Community Church",
    description:
      "Use your gifts to make a difference. Discover volunteer opportunities in worship, kids ministry, hospitality, tech, and more.",
...
export default function GetInvolvedPage() {
  const ministryAreas: {
  ...
  }[] = [
    {
      ...
      title: "Worship Team",
      description:
        "Share your musical gifts—vocals, instruments, or running sound. Help create an atmosphere where people can connect with God.",
    ...
    },
    {
      ...
      title: "Greeter / Usher",
      description:
        "Be a friendly face at the door, hand out bulletins, help visitors find a seat, and make everyone feel welcome.",
    ...
    },
    {
      ...
      title: "Hospitality",
      description:
        "Serve coffee, set up snacks, and create a warm atmosphere where people can connect before and after service.",
    ...
    },
    {
      ...
      title: "Tech & Media",
      description:
        "Run slides, manage live stream, or help with video production. Keep our services running smoothly.",
    ...
    },
    {
      ...
      description:
        "Help coordinate community service projects, outreach events, and ways we can love our neighbors well.",
    ...
    },
    {
      ...
      description:
        "Lead a Home Huddle and help others grow in community and faith. Training provided!",
    ...
    <div className="page-wrapper">
      ...
      <section className="page-hero page-hero-involved">
        ...
        <div className="page-hero-content">
          ...
          <p className="page-hero-subtitle">Everyone has something to offer. Find your place.</p>
        </div>
      </section>
        ...
        <div className="container container-narrow">
          <div className="intro-content">
            ...
            <p className="intro-lead">
              We believe everyone has gifts and talents meant to be shared. When you serve,
              you&apos;re not just filling a slot—you&apos;re using what God gave you to make a real
              difference in people&apos;s lives.
            </p>
            <p>
              The best part? Serving is where some of the deepest friendships happen. There&apos;s
              something about working alongside others toward a common purpose that bonds people
              together.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="involved-why-content">
            ...
            <div className="involved-why-text">
              ...
              <p>
                When you serve at Thrive, you&apos;re not just checking a box or filling a need.
              ...
              <ul className="involved-why-list">
                <li>
                  ...
                  <span>
                    <strong>Use your gifts</strong> in ways that actually matter
                  </span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faStar} />
                  <span>
                    <strong>Build friendships</strong> with people who share your values
                  </span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faStar} />
                  <span>
                    <strong>Grow spiritually</strong> as you step out in faith
                  </span>
                </li>
                <li>
                  <FontAwesomeIcon icon={faStar} />
                  <span>
                    <strong>Make an impact</strong> on people&apos;s lives every week
                  </span>
                </li>
              </ul>
            </div>
      ...
      <section className="section involved-cta-section">
        <div className="container container-narrow">
          <div className="cta-content">
            ...
            <p>
              Whether you know exactly where you want to serve or you&apos;re still figuring it out,
              we&apos;d love to chat. No pressure—just a conversation about how you might fit.
            </p>
            <CTAButtons>
              <Link
                href="/contact?subject=volunteer#contact-form"
        ...
        <div className="container container-narrow">
          <div className="involved-give-content">
            <div className="involved-give-text">
              ...
              <p>
                Not everyone can give their time—and that&apos;s okay. Your generosity helps us
                reach more people, support families in need, and keep our doors open for anyone
                seeking hope.
              </p>
              <a
                href="/give"
